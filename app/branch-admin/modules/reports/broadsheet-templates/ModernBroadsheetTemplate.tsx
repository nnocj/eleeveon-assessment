...
/**
 * reports/broadsheet-templates/ModernBroadsheetTemplate.tsx
 * ---------------------------------------------------------
 * ELEEVEON SCHOOLS — MODERN BROADSHEET TEMPLATE
 * ---------------------------------------------------------
 *
 * One contemporary, polished renderer for:
 * - subject broadsheets
 * - class broadsheets
 ...
 * - soft summary cards
 * - rounded landscape sheet
 * - branded table headers
 * - subtle zebra rows
 * - clean borders and generous visual hierarchy
...
import BroadsheetModernHeader from "../shared/headers/broadsheets/BroadsheetModernHeader";
...
export default function ModernBroadsheetTemplate({
  kind,
  dataset,
  header,
  template,
  ...
  const pageStyle: React.CSSProperties = {
    ...
    border: "1px solid #dbe3ee",
    borderRadius: 18,
    boxShadow: "0 20px 52px rgba(15,23,42,.10)",
  };
  ...
  return (
    <section
      className={`print-page report-page-break broadsheet-template-page broadsheet-modern-page ${className || ""}`}
      style={pageStyle}
    >
