...
/**
 * reports/broadsheet-templates/ClassicBroadsheetTemplate.tsx
 * ---------------------------------------------------------
 * ELEEVEON SCHOOLS — CLASSIC BROADSHEET TEMPLATE
 * ---------------------------------------------------------
 *
 * One formal low-ink renderer for:
 * - subject broadsheets
 * - class broadsheets
...
function tableStyles(compact: boolean): TableStyleSet {
  return {
    table: {
      width: "100%",
    ...
    th: {
      ...
      padding: compact ? "3px 3px" : "4px 4px",
      background: "#e9e9e9",
      color: "#111",
      textAlign: "center",
    ...
    td: {
      border: "1px solid #111",
      padding: compact ? "2.5px 3px" : "3.5px 4px",
      verticalAlign: "middle",
      whiteSpace: "nowrap",
    },
  };
    ...
    >
      ...
      <div style={{ minWidth: 0 }}>
        ...
        {student.admissionNumber && (
          <div style={{ marginTop: 1, fontSize: "0.88em", color: "#444" }}>
            {student.admissionNumber}
          </div>
        )}
      </div>
...
export default function ClassicBroadsheetTemplate({
  kind,
  dataset,
  header,
  template,
  ...
  return (
    <section
      className={`print-page report-page-break broadsheet-template-page broadsheet-classic-page ${className || ""}`}
      style={pageStyle}
    >
