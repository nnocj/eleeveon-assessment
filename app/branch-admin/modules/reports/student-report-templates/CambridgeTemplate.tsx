...
/**
 * reports/student-report-templates/CambridgeTemplate.tsx
 * ---------------------------------------------------------
 * ELEEVEON SCHOOLS — CAMBRIDGE INTERNATIONAL STUDENT REPORT TEMPLATE
 * ---------------------------------------------------------
 *
 * Visual direction:
 * - fixed A4/PDF sheet with an international academic / exam-board identity
 * - compact CambridgeHeader with structured metadata and restrained navy styling
 * - learner profile strip instead of decorative letterhead or certificate framing
 * - precise results table with clear examination-style hierarchy
 * - achievement summary, academic comments, period dates and generated date
 *
 * Data rule:
...
export default function CambridgeTemplate({
    ...
    mergeStudentReportTemplateSettings(
      {
        ...DEFAULT_STUDENT_REPORT_TEMPLATE_SETTINGS,
        ...(settings || {}),
        templateCode: "cambridge",
        layoutKey: "cambridge",
        templateName: "Cambridge",
  ...
  if (!dataset || !report || !header || !normalized) {
    return (
      <div className="src-empty-card cambridge-template-empty">
        <style>{css}</style>
  ...
  const upgradedPageStyle: React.CSSProperties = {
    ...
    margin: "0 auto 18px",
    padding: pagePadding,
    background: "linear-gradient(180deg, #ffffff, #f8fbff 42%, #ffffff)",
    color: "#0f172a",
  ...
  const reportPage = (
    <section
      className="print-page report-page-break student-report-card-page src-a4-page cambridge-template-page"
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="cambridge-frame-line cambridge-frame-outer"
        style={{ borderColor: primary }}
      />
      <div
        aria-hidden="true"
        className="cambridge-frame-line cambridge-frame-inner"
      />
      <div
        aria-hidden="true"
        className="cambridge-corner cambridge-corner-tl"
        style={{ borderColor: primary }}
      />
      <div
        aria-hidden="true"
        className="cambridge-corner cambridge-corner-tr"
        style={{ borderColor: primary }}
      />
      <div
        aria-hidden="true"
        className="cambridge-corner cambridge-corner-bl"
        style={{ borderColor: primary }}
      />
      <div
        aria-hidden="true"
        className="cambridge-corner cambridge-corner-br"
        style={{ borderColor: primary }}
      />
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        <CambridgeHeader
          ...
          dataset={dataset}
          settings={resolvedSettings}
          title="International Academic Progress Report"
          compact={compact}
          primaryColor={primary}
                ...
                <tr key={subject.classSubjectId}>
                  ...
                  {resolvedSettings.showGrade && (
                    <td style={{ ...tableStyles.td, textAlign: "center" }}>
                      <span
                        className="cambridge-grade-pill"
        ...
        {(currentPeriodEndLine || nextPeriodLine || generatedDateValue) && (
          ...
          >
            ...
            {currentPeriodEndLine && nextPeriodLine && (
              ...
              >
                <span
                  className="cambridge-timeline-marker"
                  style={{ borderColor: primary }}
                />
              </div>
            )}
...
.cambridge-frame-line {
  position: absolute;
  pointer-events: none;
  z-index: 0;
  border-radius: 18px;
}
.cambridge-frame-outer { inset: 4.5mm; border: 1.5px solid; opacity: .65; }
.cambridge-frame-inner { inset: 6.5mm; border: 1px solid #e5e7eb; }
.cambridge-corner {
  position: absolute;
  z-index: 0;
  width: 17mm;
...
.cambridge-corner-tl { left: 4.5mm; top: 4.5mm; border-left: 3px solid; border-top: 3px solid; border-top-left-radius: 18px; }
.cambridge-corner-tr { right: 4.5mm; top: 4.5mm; border-right: 3px solid; border-top: 3px solid; border-top-right-radius: 18px; }
.cambridge-corner-bl { left: 4.5mm; bottom: 4.5mm; border-left: 3px solid; border-bottom: 3px solid; border-bottom-left-radius: 18px; }
.cambridge-corner-br { right: 4.5mm; bottom: 4.5mm; border-right: 3px solid; border-bottom: 3px solid; border-bottom-right-radius: 18px; }
.cambridge-grade-pill {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  min-width: 24px;
...
.cambridge-timeline-marker::before,
.cambridge-timeline-marker::after {
  content: "";
  position: absolute;
  top: 50%;
  width: 16px;
...
.cambridge-timeline-marker::before { right: 100%; }
.cambridge-timeline-marker::after { left: 100%; }
...
@media print {
  ...
  .cambridge-template-page [data-report-color-block="true"] {
