...
/**
 * reports/student-report-templates/KindergartenTemplate.tsx
 * ---------------------------------------------------------
 * ELEEVEON SCHOOLS — KINDERGARTEN SOFT EARLY-YEARS STUDENT REPORT TEMPLATE
 * ---------------------------------------------------------
 *
 * Visual direction:
 * - fixed A4/PDF sheet with a soft early-years progress-card identity
 * - compact KindergartenHeader with warm rounded classroom styling
 * - little learner profile panel with optional photo and friendly chips
 * - gentle learning-area table, growth snapshot and warm comment cards
...
export default function KindergartenTemplate({
  dataset,
  template,
  settings,
  compact = false,
  ...
  if (!dataset || !report || !header || !normalized) {
    return (
      <div className="src-empty-card kindergarten-template-empty">
        <style>{css}</style>
  ...
  const reportPage = (
    <section
      className="print-page report-page-break student-report-card-page src-a4-page kindergarten-template-page"
          ...
          >
            ...
            >
              <div style={{ minWidth: 0 }}>
                <div style={smallLabel}>Little Learner Profile</div>
                <div
                  style={{
                    marginTop: 1,
          ...
          {resolvedSettings.showStudentPhoto && (
            ...
            >
              {studentPhoto ? (
                ...
                <span
                  style={{ fontSize: 9, fontWeight: 950, color: "#78716c" }}
                >
                  PHOTO
                </span>
              )}
                ...
                <tr key={subject.classSubjectId}>
                  ...
                  {resolvedSettings.showGrade && (
                    <td style={{ ...tableStyles.td, textAlign: "center" }}>
                      <span
                        className="kindergarten-grade-badge"
            ...
            {summaryCards.map((card, index) => (
              <div
                ...
                style={{
                  ...
                  background: "linear-gradient(180deg, #ffffff, #9a621e)",
                }}
              >
...
.ib-frame-outer { inset: 4.5mm; border: 1.5px solid; opacity: .65; }
.ib-frame-inner { inset: 6.5mm; border: 1px solid #e5e7eb; }
.ib-corner {
  position: absolute;
  z-index: 0;
  width: 17mm;
...
.ib-corner-tl { left: 4.5mm; top: 4.5mm; border-left: 3px solid; border-top: 3px solid; border-top-left-radius: 18px; }
.ib-corner-tr { right: 4.5mm; top: 4.5mm; border-right: 3px solid; border-top: 3px solid; border-top-right-radius: 18px; }
.ib-corner-bl { left: 4.5mm; bottom: 4.5mm; border-left: 3px solid; border-bottom: 3px solid; border-bottom-left-radius: 18px; }
.ib-corner-br { right: 4.5mm; bottom: 4.5mm; border-right: 3px solid; border-bottom: 3px solid; border-bottom-right-radius: 18px; }
.kindergarten-grade-badge {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  min-width: 24px;
...
.ib-timeline-marker::before,
.ib-timeline-marker::after {
  content: "";
  position: absolute;
  top: 50%;
  width: 16px;
...
.ib-timeline-marker::before { right: 100%; }
.ib-timeline-marker::after { left: 100%; }
...
@media print {
  ...
  .kindergarten-template-page [data-report-color-block="true"] {
