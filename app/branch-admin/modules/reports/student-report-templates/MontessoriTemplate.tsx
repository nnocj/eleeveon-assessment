...
export default function MontessoriTemplate({
  ...
  const reportPage = (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="montessori-frame-line montessori-frame-outer"
        style={{ borderColor: primary }}
      />
      <div
        aria-hidden="true"
        className="montessori-frame-line montessori-frame-inner"
      />
      <div
        aria-hidden="true"
        className="montessori-corner montessori-corner-tl"
        style={{ borderColor: primary }}
      />
      <div
        aria-hidden="true"
        className="montessori-corner montessori-corner-tr"
        style={{ borderColor: primary }}
      />
      <div
        aria-hidden="true"
        className="montessori-corner montessori-corner-bl"
        style={{ borderColor: primary }}
      />
      <div
        aria-hidden="true"
        className="montessori-corner montessori-corner-br"
        style={{ borderColor: primary }}
      />
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
          ...
          {resolvedSettings.showStudentPhoto && (
            ...
            >
              {studentPhoto ? (
                ...
                <span
                  style={{ fontSize: 9, fontWeight: 950, color: "#6f6a5f" }}
                >
                  PHOTO
                </span>
              )}
                ...
                <tr key={subject.classSubjectId}>
                  ...
                  {resolvedSettings.showGrade && (
                    <td style={{ ...tableStyles.td, textAlign: "center" }}>
                      <span
                        className="montessori-grade-badge"
        ...
        {(currentPeriodEndLine || nextPeriodLine || generatedDateValue) && (
          ...
          >
            ...
            {currentPeriodEndLine && nextPeriodLine && (
              ...
              >
                <span
                  className="montessori-timeline-marker"
                  style={{ borderColor: primary }}
                />
              </div>
            )}
        ...
        >
          <span>
            Official Montessori learning record for {branding.schoolName}
          </span>
