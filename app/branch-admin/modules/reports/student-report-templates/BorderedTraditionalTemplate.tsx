...
export default function BorderedTraditionalTemplate({
  ...
  const reportPage = (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="traditional-frame-line traditional-frame-outer"
        style={{ borderColor: primary }}
      />
      <div
        aria-hidden="true"
        className="traditional-frame-line traditional-frame-inner"
      />
      <div
        aria-hidden="true"
        className="traditional-corner traditional-corner-tl"
        style={{ borderColor: primary }}
      />
      <div
        aria-hidden="true"
        className="traditional-corner traditional-corner-tr"
        style={{ borderColor: primary }}
      />
      <div
        aria-hidden="true"
        className="traditional-corner traditional-corner-bl"
        style={{ borderColor: primary }}
      />
      <div
        aria-hidden="true"
        className="traditional-corner traditional-corner-br"
        style={{ borderColor: primary }}
      />
                ...
                <tr key={subject.classSubjectId}>
                  ...
                  {resolvedSettings.showGrade && (
                    <td style={{ ...tableStyles.td, textAlign: "center" }}>
                      <span
                        className="traditional-grade-seal"
        ...
        {(currentPeriodEndLine || nextPeriodLine || generatedDateValue) && (
          ...
          >
            ...
            {currentPeriodEndLine && nextPeriodLine && (
              ...
              >
                <span
                  className="traditional-timeline-seal"
                  style={{ borderColor: primary }}
                />
              </div>
            )}
