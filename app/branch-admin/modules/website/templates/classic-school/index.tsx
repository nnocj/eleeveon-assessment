...
export function ClassicSchoolTemplate({ draft, schoolName, branchName, primaryColor, compact = false }: WebsiteTemplateRenderProps) {
  ...
  return (
    <div className={`actual-website-template classic-school ${compact ? "compact" : ""}`} style={{ "--template-primary": primaryColor || "#1e3a5f" } as React.CSSProperties}>
      <div className="classic-topline">{branchName || "Main Campus"} · Excellence, Character and Service</div>
