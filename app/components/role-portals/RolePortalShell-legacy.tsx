    ...
    >
      ...
      <section className={`app-main ${sidebarHidden ? "full" : ""}`}>
        <header className="app-header">
          ...
          <div
            className="member-access"
            title={visibleMemberMeta}
          >
            <button
              type="button"
              ...
              aria-label="Switch role or workspace"
            >
            ...
            <button
              type="button"
              className={`member-center-action ${
                tab ===
                ELEEVEON_CENTER_KEY
                  ? "active"
                  : ""
              ...
              aria-label="Open Eleeveon Center"
              title="Eleeveon Center"
            >
              E
            </button>
          </div>
